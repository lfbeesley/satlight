...
# --- SCENE SETUP ---
# Clear existing mesh objects, materials, lights, and worlds to ensure a clean slate.
# This part of the script is for resetting the Blender environment.
...
def run_characterization_study():
    ...
    for alt_deg in altitude_angles:
        for az_deg in azimuth_angles:
            ...
            # --- Create and Clean Up Camera for this Iteration ---
...
if __name__ == "__main__":
    import tempfile
    saved_path = run_characterization_study()
